...
<head>
  <meta charset="UTF-8">
  <title>Inventario GT | Panel de Administracion</title>
    ...
    <?php if (isset($_SESSION["user_id"]) || isset($_SESSION["client_id"])): ?>
      <header class="main-header">
        <a href="./" class="logo">
          ...
          <span class="logo-lg">Inventario<b>GT</b></span>
        </a>
        ...
        <section class="sidebar">
          <ul class="sidebar-menu">
            <?php if (isset($_SESSION["user_id"])): ?>
              ...
              <li class="treeview <?php if (isset($_GET["view"]) && (
                                    $_GET["view"] == "sells" ||
                                    $_GET["view"] == "bydeliver" ||
                                    $_GET["view"] == "bycob" ||
                                    $_GET["view"] == "sellscancel" ||
                                    $_GET["view"] == "cotizations" ||
                                    $_GET["view"] == "sellscredit" ||
                                    $_GET["view"] == "onesell")) {
                                    echo "active";
                                  } ?>">
              ...
              <?php if (Core::$user->kind == 1 || Core::$user->kind == 2): ?>
                ...
                <?php if (Core::$user->kind == 1): ?>
                  <li class="treeview <?php if (isset($_GET["view"]) && (
                                        ...
                                        $_GET["view"] == "clients" ||
                                        $_GET["view"] == "providers" ||
                                        $_GET["view"] == "newproduct" ||
                                        $_GET["view"] == "editproduct" ||
                                        $_GET["view"] == "productbycategory" ||
                                        $_GET["view"] == "newclient" ||
                                        $_GET["view"] == "editclient" ||
                                        $_GET["view"] == "newprovider" ||
                                        $_GET["view"] == "editprovider" ||
                                        $_GET["view"] == "stocks" ||
                                        $_GET["view"] == "prices")) {
                                        echo "active";
                                      } ?>">
                  ...
                  <li class="treeview  <?php if (isset($_GET["view"]) && (
                                          $_GET["view"] == "contacts" ||
                                          $_GET["view"] == "messages" ||
                                          $_GET["view"] == "newcontact" ||
                                          $_GET["view"] == "editcontact")) {
                                          echo "active";
                                        } ?>">
                  ...
                  <li class="treeview  <?php if (isset($_GET["view"]) && (
                                          $_GET["view"] == "credit" ||
                                          $_GET["view"] == "makepayment" ||
                                          $_GET["view"] == "paymenthistory" ||
                                          $_GET["view"] == "balance" ||
                                          $_GET["view"] == "spends" ||
                                          $_GET["view"] == "newspend" ||
                                          $_GET["view"] == "editspend")) {
                ...
                <li class="treeview  <?php if (isset($_GET["view"]) && (
                                        $_GET["view"] == "inventary" ||
                                        $_GET["view"] == "search" ||
                                        $_GET["view"] == "inventaries" ||
                                        $_GET["view"] == "selectstock" ||
                                        $_GET["view"] == "inventaryval" ||
                                        $_GET["view"] == "dev" ||
                                        $_GET["view"] == "trasps" ||
                                        $_GET["view"] == "devs" ||
                                        $_GET["view"] == "re" ||
                                        $_GET["view"] == "traspase" ||
                                        $_GET["view"] == "onetraspase" ||
                                        $_GET["view"] == "onedev")) {
                                        echo "active";
                                      } ?>">
                ...
                <?php if (Core::$user->kind == 1): ?>
                  <li class="treeview <?php if (isset($_GET["view"]) && (
                                        $_GET["view"] == "inventorylog" ||
                                        $_GET["view"] == "sellsbycat" ||
                                        $_GET["view"] == "sellreports" ||
                                        $_GET["view"] == "resreport" ||
                                        $_GET["view"] == "paymentreport" ||
                                        $_GET["view"] == "paymentreport" ||
                                        $_GET["view"] == "clientreports" ||
                                        $_GET["view"] == "vendorreports" ||
                                        $_GET["view"] == "popularproductsreport")) {
                                        echo "active";
                                      } ?>">
