        ...
        <table class="table table-bordered table-hover">
          ...
          ?>
            <tr>
              ...
              <td><b><?php echo $symbol; ?> <?php $pt = $price * $p["q"];
                                            $total += $pt;
            ...
            <div class="box box-primary">
              <table class="table table-bordered">
                <tr>
                  ...
                  <td>
                    <p><b><?php echo $symbol; ?> <?php echo number_format($total / (1 + ($iva_val / 100)), 2, '.', ','); ?></b></p>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <p><b><?php echo $symbol; ?> <?php echo number_format(($total / (1 + ($iva_val / 100))) * ($iva_val / 100), 2, '.', ','); ?></b></p>
                  </td>
                </tr>
                <tr>
                  <td>
                  ...
                  <td>
                    <p><b><?php echo $symbol; ?> <?php echo number_format($total, 2, '.', ','); ?></b></p>
                  </td>
                </tr>
